...
for i in str(n) :
    ...
    position += 1
if (sum==n):
     print(f"The number {n} is a Deserium number")
else:
    print(f"The number {n} is not a Deserium number")
...
#     len-=1
# if (sum==copy):
#      print(f"The number {copy} is a Deserium number")
# else:
#     print(f"The number {copy} is not a Deserium number")
